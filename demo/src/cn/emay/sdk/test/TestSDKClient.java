...
public class TestSDKClient {
	...
	public static String password="408545";// 密码,请通过亿美销售人员获取
...
//		Client client2=new Client(softwareSerialNo,password);
	...
	public static void testSendSMS() {
		try {
			int i=SingletonClient.getClient().sendSMS(new String[] {"13818449631"}, "【尤恩思旗下】银生宝信使：您正在通过手机找回登录密码，确认码：387839，发送序号：3。","",5);//带扩展码
